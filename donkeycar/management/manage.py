...
Usage:
    manage.py (drive) [--model=<model>] [--js] [--lf] [--lft]
...
def drive(cfg, model_path=None, use_joystick=False, use_lf = False, use_lft = False):
    '''
    ...
    if use_lf:
        ...
        V.add(lk, inputs=['line/angle', 'line/intercept'], 
            ...
            run_condition='run_pilot',threaded = False)
    if use_lft:
        print('using line follower transformed')
        lf = lineFollower(True)
        V.add(lf, inputs=['cam/image_array'],
            outputs=['line/angle', 'line/intercept'],
            run_condition='run_pilot',threaded = False)
        lk = lineController()
...
if __name__ == '__main__':
    ...
    if args['drive']:
        drive(cfg, model_path = args['--model'], use_joystick=args['--js'],use_lf=args['--lf'], use_lft=args['--lft'])
